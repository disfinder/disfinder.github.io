...
Snagged on sale — a 5 amp-hour powerbank that charges from a wall outlet.
...
Calipers are generally a useful thing to have around, especially when you need to measure something for 3D printing.
{{< img-thumb-cap "tools/calipers.png" "200x" >}}{{</ img-thumb-cap >}}

### Soldering Pliers

A tool for clamping wires while soldering them. A handy alternative to a "third hand".
...
There is a dedicated [tag for camping articles](/tags/camping/).
