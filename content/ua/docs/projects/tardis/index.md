...
- [x] замки на двері
- [x] плити для принтерів
  - [x] одна для Калькулона
  - [x] друга для Єви
- [x] звукоізоляція вінілом
  - [x] задня, бокові стінки внизу
  - [x] задня і бокові стінки вгорі
  - [-] двері внизу
  - [-] двері вгорі ?
- [x] звукоізоляція ущільнювачем
- [x] електрифікація
  - [x] додатковий сет розеток всередині?
  - [x] зарядки для
    - [x] телефону
    - [x] планшета
    - [-] ноутбука
- [x] розміщення принтерів
...
Дуже жарко всередині шафи ніколи не ставало: навіть найжаркішим літом після друку найдовших проектів ~~до 40 не підбиралося~~ до 41 підбиралося дуже рідко, тому відпала необхідність у вентиляторах та їх керуванні, а також кіллсвічі.

Інші задачі завершені або скасовані (`[-]`), тому проект можна вважати закінченим (успішно)



{{< img-thumb-cap "tardis/0011_temperature_a1m.png" "400x" >}}{{</ img-thumb-cap >}}

{{< img-thumb-cap "tardis/0012_temperature_x1.png" "400x" >}}{{</ img-thumb-cap >}}

## Апдейт від 2026-06: оревуар

Місця у [новому домі](/tags/house/) для Тардіс не знайшлося - занизькі стелі, вага чимала, в гараж ставити не хотілося, та і функцію поличок там є чому виконувати.

Тардіс було виставлено на Маркетплейс і добрі люди, взявши мінібусик із Юхола, забрали собі додому за більш як пів оригінальної ціни.

Єдиний успішний проект - і той довелося відпустити в світ :)

{{< img-thumb-cap "tardis/0013_tardis-goodbye.png" "400x" >}}{{</ img-thumb-cap >}}
